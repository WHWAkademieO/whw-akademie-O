...
const EventModal = forwardRef(function (
  ...
  return (
    <div
      ...
      data-modal={itemKey}
      className={`fixed inset-0 flex w-screen pt- h-screen  flex-col justify-center pt-20 items-center transition delay-500 duration-1000 ${
        isOpen ? "z-50" : "-z-10"
      }`}
    >
      <div
      ...
      >
        ...
        {openKey && (
          <div className="flex flex-col items-center w-[90%] px-5 py-5">
            ...
            {!formSuccess ? (
              !eventItem?.acf?.is_full ? (
                ...
                <h6 className="my-10 text-center">
                  {generateJsonString(eventItem?.placeholder)?.booked}
                </h6>
              )
            ) : (
